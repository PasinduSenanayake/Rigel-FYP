...
*/
#pragma omp target data map(to:count[0:500][0:500], count_max, x_max, x_min, y_max, y_min) map(tofrom:r[0:500][0:500],g[0:500][0:500],b[0:500][0:500])
{
#pragma omp target teams
#pragma omp distribute parallel for shared( b, count, count_max, g, r, x_max, x_min, y_max, y_min) collapse(2)
