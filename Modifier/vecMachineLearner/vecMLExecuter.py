...
def processMLData():
    ...
    output = ['VECTORIZABLE']
    featureSet1 = ['CPI Rate', 'CPU_CLK_UNHALTED.THREAD', 'CPU_CLK_UNHALTED.REF_TSC', 'INST_RETIRED.ANY',
                   'INST_RETIRED.PREC_DIST', 'BR_MISP_RETIRED.ALL_BRANCHES_PS', 'CYCLE_ACTIVITY.STALLS_MEM_ANY',
    ...
    featureSet8 = ['UOPS_DISPATCHED_PORT.PORT_3', 'UOPS_DISPATCHED_PORT.PORT_4', 'UOPS_DISPATCHED_PORT.PORT_5',
                   ...
                   'UOPS_EXECUTED.CORE_CYCLES_GE_2', 'UOPS_EXECUTED.CORE_CYCLES_GE_3', 'UOPS_EXECUTED.CORE_CYCLES_NONE',
                   'UOPS_EXECUTED.THREAD', 'UOPS_ISSUED.ANY', 'UOPS_RETIRED.RETIRE_SLOTS']
